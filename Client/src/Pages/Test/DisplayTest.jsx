...
function DisplayTest() {
    ...
    const { testId, courseTitle } = state;
        ...
        <div className="min-h-screen bg-gray-900 text-white p-8">
            ...
            {score !== null ? (
                <div className="text-center bg-gray-800 p-8 rounded-lg shadow-lg max-w-2xl mx-auto">
                    <h2 className="text-3xl font-bold mb-4">Your Score: {score} / {currentTest.questions.length}</h2>
                    <button 
                        onClick={() => navigate(-1)}
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="text-center">
                        <button onClick={handleSubmit} className="bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-8 rounded-lg text-xl">
                            Submit Test
                        </button>
                    </div>
                </div>
