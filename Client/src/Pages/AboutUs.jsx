...
function AboutUs(){
    ...
    return (
        <HomeLayout>
            <div className="lg:pl-20 pt-20 flex flex-col min-h-[90vh] section-modern">
                <div className="flex flex-col lg:flex-row items-center gap-5 mx-10">
                    <section className="lg:w-1/2 space-y-10">
                        <h1 className="text-5xl font-semibold" style={{ color: 'var(--color-accent)' }}>
                ...
                <div className="w-[80vw] carousel lg:w-1/2 m-auto my-16 card-modern">
