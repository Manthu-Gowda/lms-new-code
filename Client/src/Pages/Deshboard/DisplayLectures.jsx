...
function DisplayLectures() {
  ...
  const testPassed =
    hasAttempted && testResult.score >= testResult.totalMarks * 0.5;
      ...
      return (
        <div className="w-full h-[30rem] flex items-center justify-center bg-gray-800 rounded-tl-lg rounded-tr-lg">
          <p className="text-red-500 text-lg">
            Lecture content is unavailable.
          </p>
        </div>
      );
    }
        ...
        return (
          <div className="w-full h-[30rem] flex flex-col items-center justify-center bg-gray-800 rounded-tl-lg rounded-tr-lg">
            ...
            <p className="text-sm mt-4 text-gray-400">
              If the PDF doesn't open, please check your browser's pop-up
              blocker settings.
            </p>
          </div>
        );
              ...
              <li className="space-y-2" key={lecture._id}>
                <p
                  className={`cursor-pointer p-2 rounded-md text-black ${
                    currentVideo === idx ? "bg-yellow-600" : "hover:bg-gray-300"
                  }`}
        ...
        <div className="text-center w-full">
          ...
          {role === "ADMIN" && (
            <button
              ...
              className="btn-primary px-4 py-2 rounded-md font-semibold text-lg"
            >
              Add First Lecture
            </button>
          )}
