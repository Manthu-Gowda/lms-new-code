...
function AddLecture() {
    ...
    async function onFormSubmit(e) {
        ...
        const response = await dispatch(addCourseLectures({ id: userInput.courseId, formData }));
    ...
    return (
        <div className="min-h-[90vh] flex items-center justify-center">
            ...
            >
                <h1 className="text-3xl font-bold text-center text-yellow-500">Add New Lecture</h1>
                ...
                <div className="flex flex-col gap-2">
                    <label htmlFor="description" className="text-lg font-semibold">Lecture Description</label>
                    <textarea
                        name="description"
                        id="description"
                ...
                {userInput.lectureType === "YouTube" ? (
                    <div className="flex flex-col gap-2">
                        <label htmlFor="lectureUrl" className="text-lg font-semibold">YouTube URL</label>
                        <input
                            type="text"
                            name="lectureUrl"
                            id="lectureUrl"
                    ...
                    <div className="flex flex-col gap-2">
                        <label htmlFor="lectureFile" className="text-lg font-semibold">Lecture File</label>
                        <input
                            type="file"
                            name="lectureFile"
                            id="lectureFile"
                ...
                <button type="submit" className="w-full py-3 mt-4 bg-yellow-600 hover:bg-yellow-700 rounded-md text-lg font-bold transition-all duration-300 ease-in-out">
                    Add Lecture
                </button>
            </form>
        </div>
